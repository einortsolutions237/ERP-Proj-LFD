        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-mist/40">
              ...
              <th className="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-slate">Address</th>
          ...
          <tbody className="divide-y divide-mist">
            {branches.map((row) => (
              <tr key={row.id} className="hover:bg-mist/40 transition-colors duration-200">
                ...
                <td className="px-3 py-2 text-ink">{row.address}</td>
                ...
                <td className="px-3 py-2 space-x-3">
                  <Link href={`/branches/${row.id}`} className="text-marine underline-offset-2 hover:underline">
                    Edit
                  </Link>
                  <button
                    type="button"
