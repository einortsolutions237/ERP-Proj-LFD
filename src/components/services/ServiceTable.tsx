          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-mist/40">
                ...
                <th scope="col" className="px-3 py-2 text-right text-xs font-medium uppercase tracking-wide text-slate">Duration (min)</th>
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((row) => (
                  <tr key={row.id} className="transition-colors duration-200 hover:bg-mist/40">
                    ...
                    <td className="px-3 py-2 text-right font-mono text-ink">{row.durationMinutes}</td>
