        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-mist/40">
              ...
              <th className="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-slate">Duration (min)</th>
          ...
          <tbody className="divide-y divide-mist">
            {services.map((row) => (
              <tr key={row.id} className="hover:bg-mist/40 transition-colors duration-200">
                ...
                <td className="px-3 py-2 font-mono text-right text-ink">{row.durationMinutes}</td>
                ...
                <td className="px-3 py-2 space-x-3">
                  <Link href={`/services/${row.id}`} className="text-marine underline-offset-2 hover:underline">
                    Edit
                  </Link>
                  <button
                    type="button"
